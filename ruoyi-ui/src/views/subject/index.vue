<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学科ID" prop="xid">
        <el-input
    ...
    <el-table v-loading="loading" :data="subjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学科ID" align="center" prop="xid" />
      <el-table-column label="学科名称" align="center" prop="name" />
      <el-table-column label="学科主任" align="center" prop="nameZr" />
      <el-table-column label="学科人数" align="center" prop="countPeople" />
      <el-table-column label="学科类型" align="center" prop="type" />
      <el-table-column label="学科描述" align="center" prop="desction" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="学科ID" prop="xid">
          <el-input v-model="form.xid" placeholder="请输入学科ID" />
        </el-form-item>
        <el-form-item label="学科名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入学科名称" />
        </el-form-item>
        <el-form-item label="学科主任" prop="nameZr">
          <el-input v-model="form.nameZr" placeholder="请输入学科主任" />
        </el-form-item>
        <el-form-item label="学科人数" prop="countPeople">
          <el-input v-model="form.countPeople" placeholder="请输入学科人数" />
        </el-form-item>
        <el-form-item label="学科类型" prop="type">
          <el-input v-model="form.type" placeholder="请输入学科类型" />
        </el-form-item>
        <el-form-item label="学科描述" prop="desction">
          <el-input v-model="form.desction" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('subject/subject/export', {
        ...this.queryParams
